...
const STAGE_TEMPLATES = [
  {
    ...
    introLines: [
      "立石小次郎は、若い頃に全国大会を制した演歌の実力者だった。だが孫の裕太が生まれてからは、すっかり歌から離れていた。",
      "「裕太、ちょっと散歩に行こうか」うさぎ公園の朝。そこへ黒腕章の男たちが現れる。",
      "「孫は預かった。返してほしくば、爺コブシを取り戻せ」男は一枚の要求状を残して消えた。",
      "小次郎は公園脇の公衆電話に駆け寄る。「智子さん、落ち着いて聞いてくれ。裕太がさらわれた」受話器の向こうで智子が息をのんだ。",
    ],
    restLine: "智子は震える声で言う。「お父さん、警察に連絡しないと」小次郎は首を振る。要求状には港の倉庫の地図が描かれていた。",
    clearLine: "裕太を取り戻すため、小次郎は港へ向かった。黒腕章の印は、秘密結社Xのものだった。",
    enemy: {
      name: "黒腕章の使い",
      attackPower: 1,
      kind: "agent",
