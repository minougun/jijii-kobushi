...
const JA = {
  ...
  sync: {
    ...
    openingJudge: "開幕の構え",
    openingInput: "構えて待つ",
    inputTap: "音は目安。ノーツが金の判定線に重なったらタップ",
    judgeTapBar: "金の判定線だけ見る",
    inputHold: "金の「長押」で押し続け、白い「離す」で離す",
    judgeHoldLong: "長押し中。白い「離す」が判定線に来たら離す",
    inputTapDense: "細かい拍も金の判定線に重なった瞬間にタップ",
...
const EN = {
  ...
  sync: {
    ...
    inputTap: "Use sound as a guide; tap when the marker meets the gold judgment line",
    judgeTapBar: "Watch only the gold judgment line",
    ...
    inputTapDense: "Dense taps still land on the gold judgment line",
