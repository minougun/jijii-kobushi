...
- Store copy draft: `switch-port/publishing/eshop-store-copy-2026-05-06.md`
- Media asset plan: `switch-port/publishing/media-asset-plan-2026-05-06.md`
- License register: `switch-port/publishing/license-register-2026-05-06.md`
...
| Web/Unity parity | Diff register drafted; hardware parity still pending |

## Blocked By Nintendo/Unity Approval Flow

- Switch SDK access.
- Unity Switch platform module.
- Dev kit availability.
- Store metadata field limits and exact asset specs.
- Submission checklist and rating flow details inside approved portal.

## Next Work While Waiting

- [ ] Decide final English romanization: `Jii Kobushi` or another spelling.
- [ ] Decide publisher/support name and support email.
