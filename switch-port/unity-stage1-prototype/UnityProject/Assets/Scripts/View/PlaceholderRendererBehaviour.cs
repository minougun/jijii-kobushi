...
namespace JijiiKobushi.Stage1Prototype
{
    public sealed class PlaceholderRendererBehaviour : MonoBehaviour
    {
        ...
        private void DrawStageCharacters(Rect mainRect)
        {
            ...
            PrototypeCharacterPanel.DrawStageCharacters(mainRect, stage, characterSheetTexture);
        }

        private void DrawSpecialCutin(Rect mainRect)
        {
            if (prototypeMode == PrototypeMode.EndingBonus) return;
            PrototypeCharacterPanel.DrawSpecialCutin(mainRect, specialCutinTexture, ShouldShowSpecialCutin, CurrentStageNumber, strongStyle, panelLabelStyle);
        }
