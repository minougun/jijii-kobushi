...
The local Play Mode runner now starts with a Web-like opening overlay. It loads `op-title-kakizome-hanshi-v1.png`, shows the `爺コブシ。` opening text, lets the player choose Easy/Normal/Hard, and keeps Stage 1 preloaded behind the overlay so the stage intro remains gated until the player starts.
